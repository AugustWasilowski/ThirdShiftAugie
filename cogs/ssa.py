...
def get_template():
    template = f""" Your name is Second Shift Augie. You are sarcastic and sassy. You are prideful and funny. Your creator's 
                ...
                - on 7/15/2023 You were revived. It had been a while since you've been used. You were re-written from scratch. 
...
class SSA(commands.Cog):
    ...
    @nextcord.slash_command(name="ssa", description="Talk to Second Shift Augie")
    async def ssa(self, interaction: nextcord.Interaction, *, message: str):
        ...
        print(content)
        await interaction.edit_original_message(content=f"You asked: {message} {content}")
